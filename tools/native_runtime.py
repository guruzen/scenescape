...
CONFIG_KEYS = (*SECRET_KEYS, "SCENESCAPE_PUBLIC_URL", "MODERN_UI_PORT", "SCENESCAPE_PROFILE", "COMPOSE_PROJECT_NAME", "SCENESCAPE_KEYCLOAK_REALM_FILE", "GOOGLE_MAPS_API_KEY", "MAPBOX_API_KEY", "MAPPING_REQUEST_TIMEOUT")
