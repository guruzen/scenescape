...
{
  "anchor_id": "anchor-a1",
  "serial_number": "SN-A1-0042",
  "scene_id": "scene-123",
  "state": "active",
  "position": { "x_m": 2.2, "y_m": 3.1, "z_m": 3.2 },
  "orientation": { "yaw_deg": 0, "pitch_deg": 0, "roll_deg": 0 },
  "capabilities": ["channel_sounding"],
  "provider_id": "gateway-west",
  "provider_device_id": "vendor-stable-id",
  "revision": 3
}
```
...
```json
{
  ...
  "provider_id": "gateway-west",
  "provider_device_id": "vendor-tag-id",
  "battery": {
    "percent": 74,
    "voltage_v": null,
    "status": "normal",
  ...
  "last_seen_at": "2026-09-24T00:00:01Z",
  "revision": 7
}
```
...
```json
{
  ...
  "session_id": "cs-9af0",
  "sequence": 48124,
  "source_timestamp": "2026-09-24T00:00:01.120Z",
  "method": "channel_sounding",
  "distance_m": 8.431,
  "distance_stddev_m": 0.12,
  "rssi_dbm": -61,
  "azimuth_deg": null,
  "elevation_deg": null,
...
{
  "schema_version": "1.0",
  "source_timestamp": "2026-09-24T00:00:01.150Z",
  "tag_id": "tag-00421",
  "scene_id": "scene-123",
  "position": { "x_m": 12.42, "y_m": 8.17, "z_m": 1.05 },
  "velocity": { "vx_mps": 0.41, "vy_mps": -0.17, "vz_mps": 0.0 },
  "quality": {
    "state": "good",
    "horizontal_uncertainty_m": 0.31,
  ...
  "tracker": { "name": "cv-kalman", "version": "1", "predicted": false }
}
```
...
```json
{
  "id": "bt:tag-00421",
  "category": "forklift",
  "translation": [12.42, 8.17, 1.05],
  "velocity": [0.41, -0.17, 0],
  "source": "bluetooth",
  "positioning": {
    "tag_id": "tag-00421",
    "method": "channel_sounding",
    ...
    "horizontal_uncertainty_m": 0.31,
    "anchors_used": 5,
    "observed_at": "2026-09-24T00:00:01.150Z"
  }
}
```
